        ...
        <div class="col-xl-4 col-md-6 mb-4">
            ...
            <div class="card-body">
                ...
                <li class="d-flex mb-4 pb-1 align-items-center">
                    <img
                    src="{{ asset('backend') }}/assets/img/icons/brands/chrome.png"
                    alt="Chrome"
                    height="28"
                    class="me-3 rounded"
                    />
                ...
                <li class="d-flex mb-4 pb-1 align-items-center">
                    <img
                    src="{{ asset('backend') }}/assets/img/icons/brands/safari.png"
                    alt="Safari"
                    height="28"
                    class="me-3 rounded"
                    />
                ...
                <li class="d-flex mb-4 pb-1 align-items-center">
                    <img
                    src="{{ asset('backend') }}/assets/img/icons/brands/firefox.png"
                    alt="Firefox"
                    height="28"
                    class="me-3 rounded"
                    />
                ...
                <li class="d-flex mb-4 pb-1 align-items-center">
                    <img
                    src="{{ asset('backend') }}/assets/img/icons/brands/opera.png"
                    alt="Opera"
                    height="28"
                    class="me-3 rounded"
                    />
                ...
                <li class="d-flex mb-4 pb-1 align-items-center">
                    <img
                    src="{{ asset('backend') }}/assets/img/icons/brands/edge.png"
                    alt="Edge"
                    height="28"
                    class="me-3 rounded"
                    />
                ...
                <li class="d-flex align-items-center">
                    <img
                    src="{{ asset('backend') }}/assets/img/icons/brands/brave.png"
                    alt="Brave"
                    height="28"
                    class="me-3 rounded"
                    />
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            ...
            <div class="card-body">
                ...
                <li class="mb-3 pb-1 d-flex">
                    ...
                    <img
                        src="{{ asset('backend') }}/assets/img/icons/brands/laravel-logo.png"
                        alt="laravel-logo"
                        class="me-3"
                        width="35"
                    />
                ...
                <li class="mb-3 pb-1 d-flex">
                    <div class="d-flex w-50 align-items-center me-3">
                    <img
                        src="{{ asset('backend') }}/assets/img/icons/brands/figma-logo.png"
                        alt="figma-logo"
                        class="me-3"
                        width="35"
                    />
                ...
                <li class="mb-3 pb-1 d-flex">
                    <div class="d-flex w-50 align-items-center me-3">
                    <img
                        src="{{ asset('backend') }}/assets/img/icons/brands/vue-logo.png"
                        alt="vue-logo"
                        class="me-3"
                        width="35"
                    />
                ...
                <li class="mb-3 pb-1 d-flex">
                    <div class="d-flex w-50 align-items-center me-3">
                    <img
                        src="{{ asset('backend') }}/assets/img/icons/brands/react-logo.png"
                        alt="react-logo"
                        class="me-3"
                        width="35"
                    />
                ...
                <li class="mb-3 pb-1 d-flex">
                    <div class="d-flex w-50 align-items-center me-3">
                    <img
                        src="{{ asset('backend') }}/assets/img/icons/brands/bootstrap-logo.png"
                        alt="bootstrap-logo"
                        class="me-3"
                        width="35"
                    />
                ...
                <li class="d-flex">
                    <div class="d-flex w-50 align-items-center me-3">
                    <img
                        src="{{ asset('backend') }}/assets/img/icons/brands/sketch-logo.png"
                        alt="sketch-logo"
                        class="me-3"
                        width="35"
                    />
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <div class="me-3">
                            <img src="{{ asset('backend') }}/assets/img/icons/payments/visa-img.png" alt="Visa" height="30" />
                        </div>
                        <div class="d-flex flex-column">
                    ...
                    <td>
                        ...
                        <div class="me-3">
                            <img
                            src="{{ asset('backend') }}/assets/img/icons/payments/master-card-img.png"
                            alt="Visa"
                            height="30"
                            />
                        </div>
                    ...
                    <td>
                        ...
                        <div class="me-3">
                            <img
                            src="{{ asset('backend') }}/assets/img/icons/payments/american-express-img.png"
                            alt="Visa"
                            height="30"
                            />
                        </div>
            ...
            <div class="card-body pb-0">
                ...
                <li class="timeline-item timeline-item-transparent ps-4">
                    ...
                    <div class="d-flex flex-wrap gap-2 pt-1">
                        ...
                        <img
                            src="{{ asset('backend') }}/assets/img/icons/misc/doc.png"
                            alt="Document image"
                            width="15"
                            class="me-2"
                        />
                        ...
                        <img
                            src="{{ asset('backend') }}/assets/img/icons/misc/xls.png"
                            alt="Excel image"
                            width="15"
                            class="me-2"
                        />
